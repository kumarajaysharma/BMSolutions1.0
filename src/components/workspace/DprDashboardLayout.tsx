// File: src/components/workspace/DprDashboardLayout.tsx  
      ...
      <main className="mx-auto max-w-7xl px-6 py-8">  
        <div className="mb-8 flex items-end justify-between">  
          ...
          <div className="flex gap-3">  
            <button className="rounded border border-stone-200 bg-white px-4 py-2 text-sm font-medium text-slate-700 shadow-sm transition-colors hover:bg-stone-50">  
              Export PDF  
            </button>  
            <button className="rounded bg-slate-900 px-4 py-2 text-sm font-medium text-white shadow-sm transition-colors hover:bg-slate-800">  
              + New Estimation  
            </button>  
          </div>  
        </div>  
